...
const WaitingListEmpty = () => {
  ...
  return (
    <>
      <div css={css([flexStyle(0, 'column', 'space-between', 'center'), { width: '100%', height: '60%' }])}>
        <div css={css(flexStyle(32, 'column'))}>
          <h1 css={css({ font: Variables.typography.font_medium_36, color: Variables.colors.text_default })}>
            공유 대기 목록이 비어있어요!
          </h1>
          <p css={css([{ font: Variables.typography.font_medium_24, color: '#4c4c4c' }, flexStyle(1, 'column')])}>
